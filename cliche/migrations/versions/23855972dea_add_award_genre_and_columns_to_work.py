...
def upgrade():
    ...
    op.add_column('works', sa.Column('number_of_pages', sa.Integer(), nullable=True))
    op.add_column('works', sa.Column('publication_date', sa.Date(), nullable=True))
...
def downgrade():
    ...
    op.add_column('works', sa.Column('title', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('works', sa.Column('dop', sa.DATE(), autoincrement=False, nullable=True))
