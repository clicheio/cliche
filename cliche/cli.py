...
def dummy():
    ...
    monty_pythons_the_meaning_of_life.tropes.update(get_tropes({
        ...
        "Misplaced Wildlife",
        "Modular Epilogue",
        "Nipple and Dimed/Thong of Shielding",
    ...
    die_hard.tropes.update(get_tropes({
        ...
        "Unstoppable Rage",
        "They Just Didn't Care (In-Universe)",
        "Victory Is Boring",
        "Villainous Breakdown",
        "Western Terrorists",
        "Wicked Cultured",
    ...
    captain_america_the_first_avenger.tropes.update(get_tropes({
        ...
        "Fake in the Hole/False Crucible",
        "Fake Ultimate Hero",
        ...
        "Shout-Out",
        "A non-comics shout-out by the prop guys",
        "Shown Their Work",
        "Shut Up, Hannibal!",
        "Single-Use Shield",
        "Single Woman Seeks Good Man",
    ...
    maverick.tropes.update(get_tropes({
        ...
        "Chekhov's Skill",
        "Chronic Backstabbing Disorder",
        "Con Men Hate Guns/Doesn't Like Guns",
        "Deadfoot Leadfoot",
    ...
    daejangguem = make_work('Dae Jang Geum', 'TV Series')
    daejangguem.tropes.update(get_tropes({
    ...
    winter_sonata = make_work('Winter Sonata', 'TV Series')
    winter_sonata.tropes.update(get_tropes({
        "Alpha Bitch",
        "Bastard Boyfriend",
        ...
        "Love Dodecahedron",
        "Love Triangle",
        "Triang Relations Type 4 —> Type 10",
    ...
    iris = make_work('IRIS', 'TV Series')
    iris.tropes.update(get_tropes({
        "Action Girl",
    ...
    pasta = make_work('Pasta', 'TV Series')
    pasta.tropes.update(get_tropes({
        "Alone in a Crowd",
    ...
    boys_over_flowers = make_work('Boys Over Flowers', 'TV Series')
    boys_over_flowers.tropes.update(get_tropes({
        "Adorkable",
        "All of the Other Reindeer",
        "Amnesiac Lover",
        "Anger Born of Worry",
